export const coaiUrl = import.meta.env.MODE === 'development' ?
  'http://localhost:18080/coai-list/coai.json' :
  'https://moodle.intel4coro.de/pluginfile.php/223/mod_resource/content/1/coai.json'
